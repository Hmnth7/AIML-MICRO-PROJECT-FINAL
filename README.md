# AIML-MICRO-PROJECT-FINAL
This project uses an Artificial Neural Network (ANN) to predict a student's career path based on academic performance and creativity score.
